...
// 全局UI
            _e(function (E, $) {
                ...
                E.UI.menus = {
                    ...
                    emotion: {
                        normal: '<a href="#" tabindex="-1"><img scr="../images/icon1.png" /></a>',
                        selected: '.selected'
                    },
                    img: {
                    ...
                    fns.onload || (fns.onload = function (resultText, xhr) {
                        ...
                        if (resultText.indexOf('error|') === 0) {
                            ...
                            img.onload = function () {
                                ...
                                img = null;
                                $('.tw_fb_ipt_new').removeAttr('disabled');
                            };
...
// h5 方式上传图片
            _e(function (E, $) {
                ...
                UploadFile.fn.selected = function (e, input) {
                    $('.tw_fb_ipt_new').attr('disabled','disable');
                    var self = this;
...
// 全局UI
    _e(function (E, $) {
        ...
        E.UI.menus = {
            ...
            // red: {
            //     normal: '<a href="#" tabindex="-1"><img src="../../images/icon1.png" style="width: 4px;" /></a>',
            //     selected: '.selected'
            // },
            // blue: {
            //     normal: '<a href="#" tabindex="-1"><img src="../../images/icon2.png" style="width: 4px;" /></a>',
            //     selected: '.selected'
            // },
            // tree: {
            //     normal: '<a href="#" tabindex="-1"><img src="../../images/icon3.png" style="width: 11px;" /></a>',
            //     selected: '.selected'
            // },
            emotion: {
                normal: '<a href="#" tabindex="-1"><img src="../../images/icon1.png" style="width: 4px;" /></a>',
            ...
            // imgtext: {
            //     normal: '<a href="#" tabindex="-1"><img src="../../images/image-text.jpg" style="width: 11px;" /></a>',
            //     selected: '.selected'
            // },
            // imgtext50: {
            //     normal: '<a href="#" tabindex="-1"><img src="../../images/image-text.jpg" style="width: 11px;" /></a>',
        ...
        E.createMenu(function (check) {
            ...
            $btnSubmit.click(function (e) {
                ...
                if (!isRangeEmpty) {
                    ...
                    // 执行命令
                    editor.command(e, 'createLink', '../'+url+'/index.html');
                    ...
                    $linkElem = $(targetElem);
                    commandFn = function () {
                        $linkElem.attr('href', '../'+url+'/index.html');
                        $linkElem.text(text);
                    };
                    callback = function () {
                        var editor = this;
                    ...
                    linkHtml = '<a href="../' + url  + '/index.html" target="_blank">' + text + '</a>';
                    if (E.userAgent.indexOf('Firefox') > 0) {
                        linkHtml += '<span>&nbsp;</span>';
                    }
                    editor.command(e, 'insertHtml', linkHtml);
...
// emotion 菜单
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            //     // 使用自定义命令
            //     function commandFn() {
            //         $p.css({"margin-left": "0px", "background": "#eaeceb", "padding": "10px", "border-radius": "5px",'text-indent': '2px'});
            //         var img = $('<img src="../../images/icon1.png" style="width: 5px;margin-right: 10px;"/>')
            //         $p.prepend(img);
            //     }
            //     editor.customCommand(e, commandFn);
            // };
            menu.clickEvent = function (e) {
                ...
                var currentQuote = editor.getSelfOrParentByName(rangeElem, 'div');
                var $quote;
                ...
                if (!rangeElem) {
                    // 执行默认命令
                    // IE8 下执行此处（不过，经测试代码无效，也不报错）
                    editor.command(e, 'formatRed', 'div');
                    return;
                }
                ...
                function commandFn() {
                        // 使用自定义命令
                    E.log($rangeElem.text())
                    $currentQuote.css({"margin-left": "0px", "background": "#eaeceb", "padding": "10px", "border-radius": "5px",'text-indent': '2px'});
                    var img = '<img  class="img" src="../../res/images/icon1.png" style="width: 5px;margin-right: 10px;"/>'
                    $currentQuote.prepend(img);
                    var $img = $('<img  class="img" src="../../res/images/icon1.png" style="width: 5px;margin-right: 10px;"/>')
                    $quote = $('<p><span>'+ img +'</span>' + $rangeElem.text() + '</p>');
                    $rangeElem.after($quote).remove();
                    $rangeElem.after($img);
                    $quote.wrap('<div class="div_box" style="margin: 10px 0 10px 0; background: #eaeceb; padding: 10px; border-radius: 5px;text-indent: 2px"></div>');
                }
            ...
            //     // 找到当前选区所在的 p 元素
            //     var elem = editor.getRangeElem();
            //     var p = editor.getSelfOrParentByName(elem, 'div');
            //     var $p;
            //
            //     if (!p) {
            //         // 未找到 p 元素，则忽略
            ...
            //     function commandFn() {
            //         // $p.css('text-indent', '0');
            //         $p.css({"margin-left": "0px", "background": "#fff", "padding": "0px", "border-radius": "0px", 'text-indent': '0'});
            //         $p.find('span').remove();
            //     }
            //     editor.customCommand(e, commandFn);
            // };
            menu.clickEventSelected = function (e) {
                ...
                // 获取当前选区的elem，并试图往上找 quote 元素
                rangeElem = editor.getRangeElem();
                quoteElem = editor.getSelfOrParentByName(rangeElem, 'div');
                if (!quoteElem) {
                    // 没找到，则返回
                    e.preventDefault();
                    return;
    ...
    _e(function (E, $) {
        ...
        //         // 使用自定义命令
        //         function commandFn() {
        //             $p.css({"margin": "10px 0 10px 0", "background": "#eaeceb", "padding": "10px", "border-radius": "5px",'text-indent': '2px'});
        //             var img = $('<img src="http://139.129.209.170/carbook-tp/Public/images/icon2.png" style="width: 5px;margin-right: 10px;"/>')
        //             $p.prepend(img);
        //         }
        //         editor.customCommand(e, commandFn);
        //     };
        ...
        //         function commandFn() {
        //             // $p.css('text-indent', '0');
        //             $p.css({"margin": "10px 0 10px 0", "background": "#fff", "padding": "0px", "border-radius": "0px", 'text-indent': '0'});
        //             $p.find('img').remove();
        //         }
        //         editor.customCommand(e, commandFn);
        //     };
        ...
        E.createMenu(function (check) {
            ...
            menu.clickEvent = function (e) {
                ...
                if (!rangeElem) {
                    // 执行默认命令
                    // IE8 下执行此处（不过，经测试代码无效，也不报错）
                    editor.command(e, 'formatBlue', 'div');
                    return;
                }
                $currentQuote = $(currentQuote)
                // 自定义command事件
                function commandFn() {
                    ...
                    E.log($rangeElem.text())
                    $currentQuote.css({"margin-left": "0px", "background": "#eaeceb", "padding": "10px", "border-radius": "5px",'text-indent': '2px'});
                    var img = '<img  class="img" src="../../res/images/icon2.png" style="width: 5px;margin-right: 10px;"/>'
                    $currentQuote.prepend(img);
                    var $img = $('<img  class="img" src="../../res/images/icon2.png" style="width: 5px;margin-right: 10px;"/>')
                    $quote = $('<p><span>'+ img +'</span>' + $rangeElem.text() + '</p>');
                    $rangeElem.after($quote).remove();
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            var menu = new E.Menu({
                editor: editor,  // 编辑器对象
                id: menuId,  // 菜单id
                title: lang.tree, // 菜单标题
                commandName: 'formatTree',
                commandValue: 'div'
                // // 正常状态和选中状态下的dom对象，样式需要自定义
                // $domNormal: $('<a href="#" tabindex="-1"><i class="wangeditor-menu-img-indent-left"></i></a>'),
                // $domSelected: $('<a href="#" tabindex="-1" class="selected"><i class="wangeditor-menu-img-indent-left"></i></a>')
            ...
            menu.clickEvent = function (e) {
                ...
                if (!rangeElem) {
                    // 执行默认命令
                    // IE8 下执行此处（不过，经测试代码无效，也不报错）
                    editor.command(e, 'formatTree', 'div');
                    return;
                }
                $currentQuote = $(currentQuote)
                // 自定义command事件
                function commandFn() {
                    ...
                    E.log($rangeElem.text())
                    $currentQuote.css({"margin-left": "0px", "background": "#eaeceb", "padding": "10px", "border-radius": "5px",'text-indent': '2px'});
                    var img = '<img  class="img" src="../../res/images/icon3.png" style="width: 11px;margin-right: 10px;"/>'
                    $currentQuote.prepend(img);
                    var $img = $('<img  class="img" src="../../res/images/icon3.png" style="width:11px;margin-right: 10px;"/>')
                    $quote = $('<p><span>'+ img +'</span>' + $rangeElem.text() + '</p>');
                    $rangeElem.after($quote).remove();
...
// image-text 菜单
    _e(function (E, $) {
        ...
        //         // 使用自定义命令
        //         function commandFn() {
        //              $p.css({'margin-left': '60px'});
        //              $p.find('img').css({'width': '45px', 'height':'auto !important', 'margin-right': '10px'});
        //         }
        //         editor.customCommand(e, commandFn);
        //     };
        //
        ...
        E.createMenu(function (check) {
            ...
            menu.clickEvent = function (e) {
                ...
                // 无文字，则不允许执行引用
                E.log($rangeElem.find('img'))
                if (!$rangeElem.text() || !$rangeElem.children('img').attr('src') || !$rangeElem.find('img').attr('src')) {
                    return;
                }
                ...
                if (!rangeElem) {
                    // 执行默认命令
                    // IE8 下执行此处（不过，经测试代码无效，也不报错）
                    editor.command(e, 'formatTextimg', 'div');
                    return;
                }
                $currentQuote = $(currentQuote)
                // 自定义command事件
                function commandFn() {
                    ...
                    // 使用自定义命令
                     E.log($rangeElem.html())
                    var imgsrc = $rangeElem.children('img').attr('src') || $rangeElem.find('img').attr('src')
                    // $currentQuote.css({"margin-left": "0px", "background": "#eaeceb", "padding": "10px", "border-radius": "5px",'text-indent': '2px'});
                     var img = '<img  class="img" src="'+ imgsrc +'" style="width: 35px;margin-right: 10px;"/>'
                    $currentQuote.prepend(img);
                    var $img = $('<img  class="img" src="'+ imgsrc +'" style="width: 35px;margin-right: 10px;"/>')
                    // E.log($img)
                    $quote = $('<section><p class="img" style="float: left;">'+ img +'</p><p>' + $rangeElem.text() + '</p></section>');
                    $rangeElem.after($quote).remove();
                    $rangeElem.after($img);
                    $quote.wrap('<div class="imgtext" style="margin-left: 0px; background: #eaeceb; padding: 10px;text-indent: 2px"></div>');
                }
            ...
            menu.clickEventSelected = function (e) {
                ...
                function commandFn() {
                    ...
                    $quoteElem = $(quoteElem);
                    $children = $quoteElem.children();
                    E.log($quoteElem.children().html())
                    if ($children.length) {
                        $children.each(function (k) {
                            var $item = $(this);
                            E.log($item.get(0).nodeName)
                            if ($item.get(0).nodeName === 'SECTION') {
                                if ($item.children().length) {
                                    $item.children().each(function (k) {
                                        var $item = $(this);
                                        if ($item.get(0).nodeName === 'P') {
                                             E.log('$item'+ $item.find('img').attr('src'))
                                            E.log('$item'+  $item.text())
                                            // var imgsrc = $item.find('img').attr('src')
                                            // var img = '<img  class="img" src="'+ imgsrc +'" style="width: 35px;margin-right: 10px;"/>'
                                            if ($item.find('img').attr('src')) {
                                                $quoteElem.after($item.find('img'));
                                            } else {
                                                $quoteElem.after('<p>' + $item.text() + '</p>');
                                            }
            ...
            menu.updateSelectedEvent = function () {
                ...
                var width = ''
                if (rangeElem) {
                    E.log($(rangeElem).attr('class'))
                    if($(rangeElem).attr('class') === 'imgtext50') {
                        return;
                    }
                    width = $(rangeElem).find('img').css('width')
                }
                E.log(rangeElem && width === '35px')
                if (rangeElem) {
                    return true;
                }
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            var menu = new E.Menu({
                editor: editor,  // 编辑器对象
                id: menuId,  // 菜单id
                title: lang.imgtext50, // 菜单标题
                commandName: 'formatTextimg50',
                commandValue: 'div'
                // // 正常状态和选中状态下的dom对象，样式需要自定义
                // $domNormal: $('<a href="#" tabindex="-1"><i class="wangeditor-menu-img-indent-left"></i></a>'),
                // $domSelected: $('<a href="#" tabindex="-1" class="selected"><i class="wangeditor-menu-img-indent-left"></i></a>')
            ...
            menu.clickEvent = function (e) {
                ...
                if (!rangeElem) {
                    // 执行默认命令
                    // IE8 下执行此处（不过，经测试代码无效，也不报错）
                    editor.command(e, 'formatTextimg50', 'div');
                    return;
                }
                $currentQuote = $(currentQuote)
                // 自定义command事件
                function commandFn() {
                    ...
                    // $currentQuote.css({"margin-left": "0px", "background": "#eaeceb", "padding": "10px", "border-radius": "5px",'text-indent': '2px'});
                    var img = '<img  class="img" src="'+ imgsrc +'" style="width: 50px;margin-right: 10px;"/>'
                    $currentQuote.prepend(img);
                    var $img = $('<img  class="img" src="'+ imgsrc +'" style="width: 50px;margin-right: 10px;"/>')
                    // E.log($img)
                    $quote = $('<section><p style="float: left;">'+ img +'</p><p class="mm">' + $rangeElem.text() + '</p></section>');
                    $rangeElem.after($quote).remove();
                    $rangeElem.after($img);
                    $quote.wrap('<div class="imgtext50" style="margin-left: 0px; background: #eaeceb; padding: 10px;text-indent: 2px"></div>');
                }
                            ...
                            if ($item.get(0).nodeName === 'SECTION') {
                                if ($item.children().length) {
                                    $item.children().each(function (k) {
                                        var $item = $(this);
                                        if ($item.get(0).nodeName === 'P') {
                                            E.log('$item50'+ $item.find('img').attr('src'))
                                            E.log('$item50'+  $item.text())
                                            // var imgsrc = $item.find('img').attr('src')
                                            // var img = '<img  class="img" src="'+ imgsrc +'" style="width: 35px;margin-right: 10px;"/>'
                                            if ($item.find('img').attr('src')) {
                                                $quoteElem.after($item.find('img'));
            ...
            menu.updateSelectedEvent = function () {
                ...
                var width = ''
                if (rangeElem) {
                    if($(rangeElem).attr('class') === 'imgtext') {
                        return;
                    }
                    // width = $(rangeElem).find('img').css('width')
                }
                // E.log(rangeElem && width === '50px')
                if (rangeElem) {
                    return true;
                }
...
// 上传图片事件
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            fns.onload || (fns.onload = function (resultText, xhr) {
                ///
                E.log('上传结束，返回结果为 ' + resultText + '' + JSON.parse(resultText).data.resultPath);
                resultText = JSON.parse(resultText).data.resultPath
                var editor = this;
                var originalName = editor.uploadImgOriginalName || '';  // 上传图片时，已经将图片的名字存在 editor.uploadImgOriginalName
                var img;
                if (resultText.indexOf('error|') === 0) {
